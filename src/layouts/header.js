...
const Header = () => {
  ...
  return (
    <ShadedContainer className="relative container mx-auto max-w-3xl h-12 flex flex-row justify-between items-center px-2">
      ...
      <div className="p-4 pr-0" onClick={() => setMenuVisible(true)}>
        <MenuIcon className="block md:hidden text-3xl text-white" />
      </div>
      <Drawer
