    ...
    <div>
      <Cover className="h-screen flex items-center text-white">
        <div className="flex flex-col items-center mx-auto">
          <div className="font-bold uppercase tracking-wider text-3xl sm:text-6xl mb-6">
            Loved, Loving.
          </div>
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="md:border-l-2 md:pl-6 md:ml-6 sm:text-xl lg:text-2xl text-center">
              Live online Sundays at 9:30AM on{" "}
              <a
                className="font-semibold border-b border-dotted hover:text-gray-300"
                href="http://live.mcac.church"
              >
                YouTube
              </a>
            </div>
      ...
      <section className="bg-gray-200 py-8 sm:py-16 px-1 text-center sm:text-lg md:text-xl">
        <div className="max-w-2xl mx-auto">
          ...
          <strong>
            because God loves us, we will love Jesus, love His people, and love
        ...
        <section className="py-8 sm:py-16 px-1 text-center sm:text-lg md:text-xl">
          ...
          <ul className="container mx-auto mt-8 sm:mt-16 flex flex-wrap md:text-lg">
            {groups.map((group, index) => (
              <li
                key={index}
                className="flex flex-col mb-8 sm:mb-16 sm:w-1/2 md:w-1/3 mx-auto"
              >
